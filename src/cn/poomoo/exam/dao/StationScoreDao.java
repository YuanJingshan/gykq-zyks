 ...
 * @author YuanJingshan
 */
public class StationScoreDao extends BaseDao {

	public StationScoreDao() {
		
	}
	
	public List<StationScore> getList(String sqlString) {
		List<StationScore> list = new ArrayList<StationScore>();
		...
		try {
			...
			if (resultSet != null) {
				while (resultSet.next()) {
					StationScore stationScore = getUserByResultSet(resultSet);
	...
	public StationScore getObj(String sqlString) {
	...
	public StationScore getUserByResultSet(ResultSet resultSet) {
