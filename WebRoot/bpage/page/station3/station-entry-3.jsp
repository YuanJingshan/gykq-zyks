...
<script type="text/javascript" src="bpage/page/station3/js/station-entry-3.js"></script>
    	...
    	<div class="body_right_1">
            ...
            <div class="occupying_right_1">
                <div class="column_left_2">
                    <h3 class="monitor_title">第三考站-分号进入考场</h3>
                    <p class="monitor_f">
                    ...
                    <div class="monitor_list">
                       ...
                       <textarea id="not-entry-info-m" style="display:none;">
					    	{#foreach $T as record}
					    	<li id="{$T.record.id}">
					    		<a href="javascript:void(0);" onclick = "entryStation3Exam({$T.record.id})">
                              ...
                              <tr>
                                <td colspan="2" align="center">
                                    <div style="width:260px; margin-left:auto; margin-right:auto;">
                                        ...
                                        <a  href ="javascript:void(0);" onclick = "queryStation3DoctorInfoByHand();" class="submit">确　定</a>
                                    </div>
                                </td>
                              </tr>
                            </table>
                        ...
                        <div id="doctor-info" class="white_content1">
                            ...
                            <textarea id="doctor-tmplete-m" style="display:none;">
				                ...
				                <tr>
				                    ...
				                    <th width="30%">题组号：</th>
				                    <td width="20%">{$T.record.topic3}</td>
				                </tr>
				                <tr>
				                    <th width="30%">报名编号：</th>
				                ...
				                <tr>
	                                <td colspan="4" align="center">
	                                    <div style="width:260px; margin-left:auto; margin-right:auto;">
	                                        ...
	                                        <a  href ="javascript:void(0)" onclick = "station3InspectConfirm({$T.record.id});" class="submit">确　定</a>
	                                    </div>
	                                </td>
                              	</tr>
						  	 	{#/for}
                ...
                <div class="column_right_x">
			    	...
			    	{#foreach $T as record}
                    	<li><a href="javascript:void(0);" onclick="cancalStation3ExamEntried({$T.record.id});">{$T.record.serialNumber}号</a></li>
			  	 	{#/for}
			  	 	</textarea>
                </div>
                <div class="clear"></div>
