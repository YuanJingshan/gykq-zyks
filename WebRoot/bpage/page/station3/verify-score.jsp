...
<script type="text/javascript" src="bpage/page/station3/js/verify-score.js"></script>
    	...
    	<div class="body_right_1">
            ...
            <div class="occupying_right_1">
            	...
            	<div style="width:260px; margin-left:auto; margin-right:auto;" class="ty_bg_c_10">
                    <a class="reset" href="javascript:void(0);" onclick="openPage('/doctorexam/bpage/page/station3/verify.jsp?id={$T.record.id}','_self');">取　消</a>
