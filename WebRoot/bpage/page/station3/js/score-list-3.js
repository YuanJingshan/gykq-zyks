...
$(function() { 
	...
	// 分页
	setParam(10,"stationScoreServlet?method=getCountThree","stationScoreServlet?method=getPageDataThree","stationScoreServlet?method=deleteThree","pageSize=10&pageNum=");
	getPageCount();
	getPageAndDisplay();
