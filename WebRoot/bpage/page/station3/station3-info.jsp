...
<head>
<base href="<%=basePath%>">
<title>医师资格实践技能考试计算机控制系统(贵阳考点)-第三考站情况</title>
<jsp:include page="../css-js-lib.jsp"></jsp:include>
<script type="text/javascript" src="bpage/page/station3/js/station3-info.js"></script>
    ...
    <div class="body_right">
    	<div class="body_right_1">
            ...
            <div class="occupying_right_1">
            	<h3 class="monitor_title">第三考站-考站情况</h3>
