...
<script type="text/javascript" src="bpage/page/station3/js/station-score-3.js"></script>
    	...
    	<div class="body_right_1">
            ...
            <div class="occupying_right_1">
                <div class="column_left_2">
                    <h3 class="monitor_title">第三考站-登分出站</h3>
                    <p class="monitor_f">
                    ...
                    <div class="monitor_list">
                       ...
                       <textarea id="entried-info-m" style="display:none;">
					    	{#foreach $T as record}
					    	<li id="{$T.record.id}">
					    		<a href="javascript:void(0);" onclick = "openPage('/doctorexam/bpage/page/station3/add-score-3.jsp?id={$T.record.id}&topic={$T.record.serialNumber}','_self');">
                ...
                <div class="column_right_x">
                	<h3 class="column_right_title">已考完出站<span id="exit-num">0</span>人</h3>
                	<div>
