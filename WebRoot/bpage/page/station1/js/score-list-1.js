...
$(function() { 
	...
	// 分页
	setParam(10,"stationScoreServlet?method=getCountFirst","stationScoreServlet?method=getPageDataFirst","stationScoreServlet?method=deleteFirst","pageSize=10&pageNum=");
	getPageCount();
	getPageAndDisplay();
