...
<script type="text/javascript" src="bpage/page/station1/js/station-score-1.js"></script>
    	...
    	<div class="body_right_1">
            ...
            <div class="occupying_right_1">
                <div class="column_left_2">
                    <h3 class="monitor_title">第一考站-登分</h3>
                    <p class="monitor_f">
                    ...
                    <div class="monitor_list">
                       ...
                       <textarea id="entried-info-m" style="display:none;">
					    	...
					    	<li id="{$T.record.doctorId}">
					    		<a href="javascript:void(0);" onclick = "openPage('/doctorexam/bpage/page/station1/add-score-1.jsp?id={$T.record.id}&topic={$T.record.serialNumber}','_self');">
