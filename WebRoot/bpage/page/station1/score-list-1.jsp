...
<script type="text/javascript" src="bpage/page/station1/js/score-list-1.js"></script>
    ...
    <div class="body_right">
    	<div class="body_right_1">
    		<div class="body_right_top">
           	  <p class="body_right_top_left"><a href="javascript:void(0);">第一考站</a>&nbsp;>&nbsp;<a href="javascript:void(0);"><strong>考试成绩</strong></a></p>
              <div class="clear"></div>
            </div>
            ...
            <div class="occupying_right_1">
				<table border="0" align="center" cellpadding="0" cellspacing="0" class="ty_bg_c">
                  <tr>
                    ...
                    <th width="4%">&nbsp;</th>
                    <th width="10%"><a href="javascript:void(0);" onclick="querySationScore_1();" class="submit">查询</a></th>
                    <c:if test="${sessionScope.user.authority == 1}">
                    	<th width="10%"><a href="javascript:void(0);" onclick="exportExcelStation1();" class="submit">excel导出</a></th>
                    </c:if>
		  	 	...
		  	 	<tr>
		  	 		...
		  	 		<c:choose>
		  	 			<c:when test="${sessionScope.user.authority == 1}">
		  	 				<td align="center">
				  	 			<a href="javascript:void(0);" onclick="openPage('/doctorexam/bpage/page/station1/modify-score-1.jsp?id={$T.record.doctorId}','_self');">修改</a>
				  	 		</td>
		  	 			</c:when>
		  	 			<c:otherwise>
		  	 				<td align="center"> </td>
