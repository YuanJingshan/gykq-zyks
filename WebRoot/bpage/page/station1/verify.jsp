...
<script type="text/javascript" src="bpage/page/station1/js/verify.js"></script>
                    ...
                    <div class="monitor_list">
                       ...
                       <textarea id="score_info_m" style="display:none;">
					    	...
					    	<li id="{$T.record.doctorId}">
					    		<a href="javascript:void(0);" onclick = "openPage('/doctorexam/bpage/page/station1/verify-score.jsp?id={$T.record.id}','_self');">
