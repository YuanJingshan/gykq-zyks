...
<head>
<base href="<%=basePath%>">
<title>医师资格实践技能考试计算机控制系统(贵阳考点)-第二考站</title>
<jsp:include page="../css-js-lib.jsp"></jsp:include>
<script type="text/javascript" src="bpage/page/station2/js/station-entry-2.js"></script>
    	...
    	<div class="body_right_1">
            ...
            <div class="occupying_right_1">
                <div class="column_left_2">
                    <h3 class="monitor_title">第二考站-分号进入考场</h3>
                    <p class="monitor_f">
                    ...
                    <div class="monitor_list">
                       ...
                       <textarea id="not-entry-info-m" style="display:none;">
					    	{#foreach $T as record}
					    	<li id="{$T.record.id}">
					    		<a href="javascript:void(0);" onclick = "entryStation2Exam({$T.record.id})">
                              ...
                              <tr>
                                <td colspan="2" align="center">
                                    <div style="width:260px; margin-left:auto; margin-right:auto;">
                                        ...
                                        <a  href ="javascript:void(0);" onclick = "queryStation2DoctorInfoByHand();" class="submit">确　定</a>
                                    </div>
                                </td>
                              </tr>
                            </table>
                        ...
                        <div id="doctor-info" class="white_content1">
                            ...
                            <textarea id="doctor-tmplete-m" style="display:none;">
				                ...
				                <tr>
				                    ...
				                    <th width="30%">题组号：</th>
				                    <td width="20%">{$T.record.topic2}</td>
				                </tr>
				                <tr>
				                    <th width="30%">报名编号：</th>
                                ...
                                <td colspan="4" align="center">
                                    <div style="width:260px; margin-left:auto; margin-right:auto;">
                                        ...
                                        <a  href ="javascript:void(0);" onclick = "station2InspectConfirm({$T.record.id});" class="submit">确　定</a>
                                    </div>
                                </td>
                              	</tr>
						  	 	{#/for}
                ...
                <div class="column_right_x">
			    	...
			    	{#foreach $T as record}
                    	<li><a href="javascript:void(0);" onclick="cancalStation2ExamEntried({$T.record.id});">{$T.record.serialNumber}号</a></li>
			  	 	{#/for}
			  	 	</textarea>
                </div>
                <div class="clear"></div>
