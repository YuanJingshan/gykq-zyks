...
<head>
<base href="<%=basePath%>">
<title>执业医师实践技能考试系统-异常考生信息</title>
...
<script type="text/javascript" src="bpage/page/doctor/js/doctor-error-exam.js"></script>
    ...
    <div class="body_right">
    	<div class="body_right_1">
    		<div class="body_right_top">
           	  <p class="body_right_top_left"><a href="javascript:void(0);">查询统计</a>&nbsp;>&nbsp;<a href="javascript:void(0);"><strong>异常考生统计</strong></a></p>
              <div class="clear"></div>
            </div>
            ...
            <textarea id="tmplete-m" style="display:none;">
		    	{#foreach $T as record}
		  	 	<tr>
		  	 		...
		  	 		{#/if}
		  	 		<td align="center">
		  	 			<a href="javascript:void(0);" onclick="addErrorDoctorScore({$T.record.doctorId});">未考项给0分</a>
		  	 		</td>
		  	 	</tr>
		  	 	{#/for}
		    </textarea>
