    	...
    	<div class="body_right_1">
            ...
            <div class="occupying_right_1">
            	...
            	<div style="width:260px; margin-left:auto; margin-right:auto;" class="ty_bg_c_10">
                    <a class="reset" href="javascript:void(0);" onclick="openPage('/doctorexam/view/management/station/verify.jsp?station=<%=station%>','_self');">取　消</a>
                    <a class="submit" href="javascript:void(0);" onclick="$.doctoreaxm.station.modify.verify();">确　认</a>
                </div>
	            {#/for}
            	</textarea>
            </div>
